...
CONSUMER_START_HOUR = int(os.getenv("CONSUMER_START_HOUR", "9"))
CONSUMER_END_HOUR = int(os.getenv("CONSUMER_END_HOUR", "20"))
PRIORITY_QUEUE_MIN = int(os.getenv("PRIORITY_QUEUE_MIN", "51"))
